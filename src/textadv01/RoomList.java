...
public class RoomList {
    ...
    public void createRooms() {
        ...
        r = new Room(" walks into a dark room, which seems\n"
                ...
                + ""
                + "", 3, 0, 2, -1, g.getNumbOfGold(), false, false, rand.chanceOfItem(), null);
        getRoomList().add(r);
        //rum 2
        r = new Room(" enters a room filled with broken glass and pottery.\n"
                + "\tWho goes around breaking glass and pottery, one wonders..."
                + ""
                + "", 4, -1, -1, 1, g.getNumbOfGold(), rand.genTrap(), false, rand.chanceOfItem(), rand.chanceOfEnemy());
        getRoomList().add(r);
        //rum 3
        r = new Room(" enters a room filled with murals,\n"
                ...
                + ""
                + "", 5, 1, 4, 6, g.getNumbOfGold(), rand.genTrap(), false, rand.chanceOfItem(), rand.chanceOfEnemy());
        getRoomList().add(r);
        //rum 4
        r = new Room(" walks slowly into a room, where light\n"
                + "\temanates from a small horse statue."
                + ""
                + "", -1, 2, -1, 3, g.getNumbOfGold(), rand.genTrap(), false, rand.chanceOfItem(), rand.chanceOfEnemy());
        getRoomList().add(r);
        //rum 5
        r = new Room(" goes into an alcove with a small rusty chest.\n"
                ...
                + ""
                + "", -1, 3, -1, -1, g.getNumbOfGold(), rand.genTrap(), false, rand.chanceOfItem(), rand.chanceOfEnemy());
        getRoomList().add(r);
        //rum 6
        r = new Room(" enters a tiny room with axes, swords and a mural\n"
                ...
                + ""
                + "", -1, -1, 3, 7, g.getNumbOfGold(), rand.genTrap(), false, rand.chanceOfItem(), rand.chanceOfEnemy());
        getRoomList().add(r);
        //rum 7
        r = new Room(" walks into a large room filled with mixture of\n"
                ...
                + "", 8, 9, 6, -1, g.getNumbOfGold(), rand.genTrap(), false, rand.chanceOfItem(), rand.chanceOfEnemy());
        getRoomList().add(r);
        //rum 8
        r = new Room(" walks into an alcove with a statue of\n"
                ...
                + "\thunger."
                + ""
                + "", -1, 7, -1, -1, g.getNumbOfGold(), rand.genTrap(), false, rand.chanceOfItem(), rand.chanceOfEnemy());
        getRoomList().add(r);
        //rum 9
        r = new Room(" enters a massive room made up by black polished marble.\n"
                ...
                + "", 7, 10, -1, -1, g.getNumbOfGold(), rand.genTrap(), false, rand.chanceOfItem(), rand.chanceOfEnemy());
        getRoomList().add(r);
        //rum 10
        r = new Room(""
                ...
                + "\tThis is the end…"
                + "", -1, -1, -1, -1, g.getNumbOfGold(), false, true, rand.chanceOfItem(), new SlutBoss("Slutty Boss", 100, 100));
        getRoomList().add(r);
